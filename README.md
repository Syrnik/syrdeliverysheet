# Печатная форма Заказ-наряд (Лист доставки товара)
...
поэтому, если очень надо чтобы в заголовке на печати была именно надпись
...
телефон магазина берутся из настроек Shop-Script.
